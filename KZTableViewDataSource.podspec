#
# Be sure to run `pod lib lint KZTableViewDataSource.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KZTableViewDataSource.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'KZTableViewDataSource' => ['KZTableViewDataSource/Assets/*.png']
  # }
